...
function buscarAsesoria() {
    ...
    if (nombre === "" || apellidoPaterno === "" || apellidoMaterno === "") {
        ...
        const url = `http://198.101.238.125:3009/asesorias/buscar?nombre=${encodeURIComponent(nombre)}&apellido_paterno=${encodeURIComponent(apellidoPaterno)}&apellido_materno=${encodeURIComponent(apellidoMaterno)}`;
        ...
        fetch(url, opciones)
            ...
            .then(data => {
                ...
                if (asesoria) {
                    ...
                    fetch(`http://198.101.238.125:3012/colonias/${idColonia}`, {
                        method: 'GET',
                        headers: {
                        ...
                        .then(dataColonia => {
                            ...
                            const dataColoniaB = JSON.stringify(dataColonia.data);
