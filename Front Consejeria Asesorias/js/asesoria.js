...
function rellenarAsesorJuicio() {
    fetch('http://198.101.238.125:3009/asesores', {
        method: 'GET',
        headers: {
    ...
    fetch('http://198.101.238.125:3009/tipos-de-juicio', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function generosEstados() {
    ...
    fetch('http://198.101.238.125:3009/generos', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
    ...
    fetch('http://198.101.238.125:3009/estados-civiles', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function motivoSelect() {
    ...
    fetch('http://198.101.238.125:3009/motivos', {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function validarCodigoPostal() {
    ...
    fetch(`http://198.101.238.125:3012/codigospostales/cp/${codigoPostal}`, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${datosAnalizadosGlobal.token}`
        }
...
function registarAsesoria() {
    ...
    fetch('http://198.101.238.125:3009/asesorias', options)
        .then(response => response.json())
        .then(data => {
